...
fn quickcheck_should_combine_set_and_increment() {
    fn should_combine_set_and_increment(offset: isize,
                                        set_amount: i8,
                                        increment_amount: i8)
                                        -> bool {
...
fn quickcheck_combine_set_and_increment_different_offsets() {
    fn combine_set_and_increment_different_offsets(set_offset: isize,
                                                   set_amount: i8,
                                                   inc_offset: isize,
                                                   inc_amount: i8)
                                                   -> TestResult {
...
fn quickcheck_combine_increment_and_set_different_offsets() {
    fn combine_increment_and_set_different_offsets(set_offset: isize,
                                                   set_amount: i8,
                                                   inc_offset: isize,
                                                   inc_amount: i8)
                                                   -> TestResult {
...
fn quickcheck_combine_set_and_set_different_offsets() {
    fn combine_set_and_set_different_offsets(offset1: isize,
                                             amount1: i8,
                                             offset2: isize,
                                             amount2: i8)
                                             -> TestResult {
...
fn should_preserve_set_0_in_loop() {
    // Regression test.
    let initial = vec![Read { position: Some(Position { start: 0, end: 0 }) },
                       Loop {
                           body: vec![Set {
                                          amount: Wrapping(0),
                                          offset: 0,
